...
[NOTE]
--
Keep in mind that you should avoid changing the configuration variables in existing files, as the tasks may have been created with the old configuration and you can get a unexpected behavior.
...
Worst case, the CI will warn you if any of these conditions are not safistied.
